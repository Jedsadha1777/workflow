...
<button type="button" id="reload_btn_{$id}" style="display:none;" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-500">Reload Html</button>
